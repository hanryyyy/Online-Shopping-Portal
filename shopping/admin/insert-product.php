...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productCompany,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount,color,size,quantity) values('$category','$subcat','$productname','$productcompany','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd','$color','$size','$quantity')");
...
<div class="controls">
<select name="size" class="span8 tip" required>
...
<div class="controls">
<input type="number" name="quantity" placeholder="Enter Quantity" class="span8 tip" required>
</div>
</div>
